...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.vked_messageLayout.setSpacing(25)
        ...
        self.vked_attachmentsLayout.setSizeConstraint(QtWidgets.QLayout.SetDefaultConstraint)
        self.vked_attachmentsLayout.setContentsMargins(-1, -1, 0, -1)
        self.vked_attachmentsLayout.setSpacing(34)
        ...
        self.vkspp_page_horizontalLayout = QtWidgets.QHBoxLayout()
        self.vkspp_page_horizontalLayout.setObjectName("vkspp_page_horizontalLayout")
        self.vkspp_backward_pushButton = QtWidgets.QPushButton(self.vkspp_respGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.vkspp_backward_pushButton.sizePolicy().hasHeightForWidth())
        self.vkspp_backward_pushButton.setSizePolicy(sizePolicy)
        self.vkspp_backward_pushButton.setObjectName("vkspp_backward_pushButton")
        self.vkspp_page_horizontalLayout.addWidget(self.vkspp_backward_pushButton)
        self.vkspp_page_label = QtWidgets.QLabel(self.vkspp_respGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.vkspp_page_label.sizePolicy().hasHeightForWidth())
        self.vkspp_page_label.setSizePolicy(sizePolicy)
        self.vkspp_page_label.setAlignment(QtCore.Qt.AlignCenter)
        self.vkspp_page_label.setObjectName("vkspp_page_label")
        self.vkspp_page_horizontalLayout.addWidget(self.vkspp_page_label)
        self.vkspp_forward_pushButton = QtWidgets.QPushButton(self.vkspp_respGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.vkspp_forward_pushButton.sizePolicy().hasHeightForWidth())
        self.vkspp_forward_pushButton.setSizePolicy(sizePolicy)
        self.vkspp_forward_pushButton.setObjectName("vkspp_forward_pushButton")
        self.vkspp_page_horizontalLayout.addWidget(self.vkspp_forward_pushButton)
        self.verticalLayout_6.addLayout(self.vkspp_page_horizontalLayout)
        ...
        self.info_ava.setAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.vkspp_backward_pushButton.setText(_translate("MainWindow", "← Назад"))
        self.vkspp_page_label.setText(_translate("MainWindow", "1"))
        self.vkspp_forward_pushButton.setText(_translate("MainWindow", "Вперёд →"))
